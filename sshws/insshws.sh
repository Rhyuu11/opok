...
wget -O /usr/local/bin/ws-ovpn https://raw.githubusercontent.com/Rhyuu11/newsc/main/sshws/ws-ovpn.py
...
wget -O /usr/local/bin/ws-stunnel https://raw.githubusercontent.com/Rhyuu11/newsc/main/sshws/ws-stunnel
